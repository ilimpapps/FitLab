...
import 'coaches_list_model.dart';
export 'coaches_list_model.dart';

class CoachesListWidget extends StatefulWidget {
  const CoachesListWidget({super.key});

  @override
  State<CoachesListWidget> createState() => _CoachesListWidgetState();
}

class _CoachesListWidgetState extends State<CoachesListWidget>
    with TickerProviderStateMixin {
  late CoachesListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoachesListModel());
