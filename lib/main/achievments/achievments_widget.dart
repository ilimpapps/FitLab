...
class AchievmentsWidget extends StatefulWidget {
  const AchievmentsWidget({super.key});
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: const BottomAchievmentsWidget(
                                              index: 1,
                                            ),
                                          ),
                                        );
